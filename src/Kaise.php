 ...
 * @author Angel Lai
 * @package Kaise
 * @copyright Copyright 2021 Kaise Project, Angel Lai.
...
class Kaise
{
    ...
    public function has(string $table, $join, $where = null): bool
    {
        ...
        $query = $this->exec(
            $this->type === 'mssql' ?
                $this->selectContext($table, $map, $join, $column, $where, Kaise::raw('TOP 1 1')) :
